...
Once you’ve got the starter code, take a look around. Install all the package dependencies using `npm install` and run the app with `npm run dev`. Notice that no matter what you put into the address field, when you click “Check SOL Balance” the balance will be a placeholder value of 1000.
